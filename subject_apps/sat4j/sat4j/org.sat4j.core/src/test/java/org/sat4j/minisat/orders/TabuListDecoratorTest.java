...
public class TabuListDecoratorTest extends TestCase{
	private TabuListDecorator decorator;
	private final VarOrderHeap order = new VarOrderHeap();
	
	
	public TabuListDecoratorTest(String arg0) {
        super(arg0);
    }
    ...
    protected void setUp() throws Exception {
    	...
    	for(int i=0;i<10;i++)
    		order.heap.insert(0);
        this.decorator = new TabuListDecorator(order);
    }
    ...
    public void testPhaseSelectionStrategy() throws Exception {
    	...
    	assertEquals(9, strategy.select(4));
    	
    	decorator.setPhaseSelectionStrategy(strategy);
    	assertEquals(9, strategy.select(4));
    }
    ...
    public void testSelectExample3() throws Exception {
    	...
    	assertEquals(3, decorator.select()); 
    }
    ...
    public void testSelectExample4() throws Exception {
    	...
    	assertEquals(3, decorator.select());
    	assertEquals(99, decorator.select());
    }
    ...
    public void testToString() throws Exception {
    	assertTrue(decorator.toString().contains("with tabu list of size"));
    }
