...
public class MixedDataStructureDanielWLTest extends TestCase{
	private MixedDataStructureDanielWL mixedDataStructure;

	public MixedDataStructureDanielWLTest(String arg0) {
        super(arg0);
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        this.mixedDataStructure = new MixedDataStructureDanielWL();
    }
