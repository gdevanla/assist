...
public class TestGroupedTimeoutModelEnumeration extends TestCase{
    ...
    public void testTimeoutOnSeconds() throws TimeoutException {
        ...
        try {
        	...
        	assertEquals(" Timeout (2000s) exceeded",e.getMessage());
        }
    }
    ...
    public void testTimeoutOnConflicts() throws TimeoutException {
        ...
        try {
        	...
        	assertEquals(" Timeout (1000 conflicts) exceeded",e.getMessage());
        }
    }
}
