...
public class VecTest extends TestCase {
    ...
    public void testInsertFirstNE(){
    	...
    	assertEquals(new Integer(1), this.myvec.get(0));
    }
    
    public void testInsertFirstEmpty() {
    	this.myvec.insertFirst(new Integer(0));
    	assertEquals(new Integer(0), this.myvec.get(0));
    }
    
    public void testInsertFirstWithShiftingNE(){
    	for (int i = 0; i < 10; i++) {
            this.myvec.push(new Integer(0));
        }   	
    ...
    public void testInsertFirstWithShiftingEmpty() {
    	this.myvec.insertFirstWithShifting(new Integer(0));
    	assertEquals(new Integer(0), this.myvec.get(0));
    }
    ...
    public void testSet() {
    	...
    	assertEquals(new Integer(5), this.myvec.get(5));
    }
