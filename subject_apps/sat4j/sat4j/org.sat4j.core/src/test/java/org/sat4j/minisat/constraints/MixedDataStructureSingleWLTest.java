...
public class MixedDataStructureSingleWLTest extends TestCase{
	private MixedDataStructureSingleWL mixedDataStructure;

	public MixedDataStructureSingleWLTest(String arg0) {
        super(arg0);
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        this.mixedDataStructure = new MixedDataStructureSingleWL();
    }
