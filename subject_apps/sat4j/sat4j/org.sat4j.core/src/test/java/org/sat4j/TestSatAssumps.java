...
public class TestSatAssumps {
    ...
    public void testIterativeAssumptionCallsWithSet()
        ...
        IProblem p = reader.parseInstance("org.sat4j.core/src/test/testfiles/Eshop-fm.dimacs");
        ...
        for (int i = 0; i < vars.size(); i++) {
            ...
            readerOracle.parseInstance("org.sat4j.core/src/test/testfiles/Eshop-fm.dimacs");
