...
public class ComponentTest extends JDependTestCase {
    ...
    public void testJDependComponentsExample1() throws Exception {
        ...
        Field comp = jdepend.getClass().getDeclaredField("components");
    	comp.setAccessible(true);
    	Collection expected = (Collection) comp.get(jdepend);
    ...
    public void testJDependComponentsExample2() throws Exception {
        ...
        Field comp = jdepend.getClass().getDeclaredField("fileManager");
    	comp.setAccessible(true);
    	FileManager expected = (FileManager) comp.get(jdepend);
