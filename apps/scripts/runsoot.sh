...
SOOT_CLASSPATH=.:$STATECARVER_BASE/src/test/java:/System/Library/Frameworks/JavaVM.framework/Classes/classes.jar

echo $SOOT_CLASSPATH
java -cp $CLASSPATH  soot.Main -f J -cp $SOOT_CLASSPATH -process-dir $STATECARVER_BASE/src/test/java/
