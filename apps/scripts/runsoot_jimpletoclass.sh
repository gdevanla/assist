...
SOOT_CLASSPATH=.:$STATECARVER_BASE/src/test/java:/System/Library/Frameworks/JavaVM.framework/Classes/classes.jar:/Users/gdevanla/.m2/repository/junit/junit/3.8.2/junit-3.8.2.jar:$STATECARVER_BASE/TestArtifacts/src/main/java

echo $SOOT_CLASSPATH
java -cp $CLASSPATH  soot.Main -f c -cp $SOOT_CLASSPATH  TestSimpleReturn101
